...
This is a sample template for aws-dict-sam - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name aws-dict-sam --query 'Stacks[].Outputs'
```
